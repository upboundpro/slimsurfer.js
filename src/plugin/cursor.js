 ...
 * @example
 * // es6
 * import CursorPlugin from 'slimsurfer.cursor.js';
 *
 * // commonjs
 * var CursorPlugin = require('slimsurfer.cursor.js');
 *
 * // if you are using <script> tags
 * var CursorPlugin = window.SlimSurfer.cursor;
 *
...
export default class CursorPlugin {
    ...
    /** @private */
    _onMousemove = e => {
        const bbox = this.slimsurfer.container.getBoundingClientRect();
     ...
     */
    init() {
        this.wrapper = this.slimsurfer.container;
        this.cursor = this.wrapper.appendChild(
            this.style(
                document.createElement('cursor'),
                this.slimsurfer.util.extend(
                    {
                        position: 'absolute',
