 ...
 * (Between 0 and 1)
 * @property {number} pixelRatio=slimsurfer.params.pixelRatio to control the
 ...
 * @example
 * // es6
 * import SpectrogramPlugin from 'slimsurfer.spectrogram.js';
 *
 * // commonjs
 * var SpectrogramPlugin = require('slimsurfer.spectrogram.js');
 *
 * // if you are using <script> tags
 * var SpectrogramPlugin = window.SlimSurfer.spectrogram;
 *
...
export default class SpectrogramPlugin {
    ...
    constructor(params, ws) {
        ...
        this._onReady = () => {
            ...
            if (!this.container) {
                throw Error('No container for SlimSurfer spectrogram');
            }
    ...
    drawSpectrogram(frequenciesData, my) {
        ...
        const length = my.slimsurfer.backend.getDuration();
    ...
    getFrequencies(callback) {
        ...
        const buffer = (this.buffer = this.slimsurfer.backend.buffer);
    ...
    loadLabels(
        ...
        const freqStart = 0;
        const step =
            (this.slimsurfer.backend.ac.sampleRate / 2 - freqStart) /
            labelIndex;
