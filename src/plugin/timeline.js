 ...
 * @example
 * // es6
 * import TimelinePlugin from 'slimsurfer.timeline.js';
 *
 * // commonjs
 * var TimelinePlugin = require('slimsurfer.timeline.js');
 *
 * // if you are using <script> tags
 * var TimelinePlugin = window.SlimSurfer.timeline;
 *
...
export default class TimelinePlugin {
    ...
    constructor(params, ws) {
        ...
        if (!this.container) {
            throw new Error('No container for slimsurfer timeline');
        }
        /** @private */
        this.slimsurfer = ws;
        /** @private */
    ...
    destroy() {
        ...
        this.slimsurfer.un('zoom', this._onZoom);
     ...
     */
    createWrapper() {
        const wsParams = this.slimsurfer.params;
     ...
     */
    renderCanvases() {
        const duration = this.slimsurfer.backend.getDuration();
        if (duration <= 0) {
            return;
        }
        const wsParams = this.slimsurfer.params;
