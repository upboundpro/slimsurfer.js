 ...
 * @example
 * // es6
 * import ElanPlugin from 'slimsurfer.elan.js';
 *
 * // commonjs
 * var ElanPlugin = require('slimsurfer.elan.js');
 *
 * // if you are using <script> tags
 * var ElanPlugin = window.SlimSurfer.elan;
 *
...
export default class ElanPlugin {
    ...
    render() {
        ...
        table.className = 'slimsurfer-annotations';
        ...
        th.textContent = 'Time';
        th.className = 'slimsurfer-time';
        headRow.appendChild(th);
        indeces.forEach(index => {
            const tier = tiers[index];
            const th = document.createElement('th');
            th.className = 'slimsurfer-tier-' + tier.id;
        ...
        this.renderedAlignable.forEach(alignable => {
            ...
            row.id = 'slimsurfer-alignable-' + alignable.id;
            tbody.appendChild(row);

            const td = document.createElement('td');
            td.className = 'slimsurfer-time';
            td.textContent =
    ...
    getAnnotationNode(annotation) {
        return document.getElementById('slimsurfer-alignable-' + annotation.id);
    }
}
