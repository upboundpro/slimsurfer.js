...
(function() {
    ...
    /**
     * @ngdoc directive
     * @name md-slimsurfer-audio
     *
     * Directive for playing a set of audio files. This directive is analogous to `<audio>` HTML tag.
     * The audio files, should be specified using the  `md-slimsurfer-source`
     *
     * SlimSurfer properties can be passed in using the prefix : player-* for attributes, e.g. `player-wave-color` is
     * equivalent to SlimSurfer's waveColor option.
     *
     * Must be used as an element.
     *
     * @usage
     * ```html
     * <md-slimsurfer-audio player-wave-color="gray" player-progress-color="black" player-backend="MediaElement">
     *   <md-slimsurfer-source src="source1" title="Title-1"></md-slimsurfer-source>
     *   <md-slimsurfer-source src="source2" title="Title-2"></md-slimsurfer-source>
     *   <md-slimsurfer-source src="source3" title="Title-3"></md-slimsurfer-source>
     *   ...
     *   <md-slimsurfer-source src="sourceN" title="Рассказы о сновидениях"></md-slimsurfer-source>
     * </md-slimsurfer-audio>
     * ```
     *
     * @param string player-* specifies SlimSurfer properties.
     *
     */
     ...
     * @ngdoc directive
     *
     * @name md-slimsurfer-source
     *
     * This directive is used within the `md-slimsurfer-audio` directive to specify an audio file source, it is
     ...
     *
     * ```html
     *   <md-slimsurfer-source src="source3" title="Title-3" album-art="Album-Art-Url" duration=""></md-slimsurfer-source>
     * ```
        ...
        function($element, $scope, attributes, $interval, $mdTheme) {
            ...
            var initWaveSurfer = function() {
                ...
                if (!control.surfer) {
                    ...
                    control.surfer = SlimSurfer.create(options);
     ...
     * @ngdoc directive
     *
     * @name md-slimsurfer-player
     *
     * @usage
     * This directive can be used as a stand-alone directive to display Audio SlimSurfer with a few controls, by default
     ...
     *
     * ```html
     *  <md-slimsurfer-player url="trackUrl" title="Track Title"
     *         extra-buttons="extraButtons" properties="properties">
     *  </md-slimsurfer-player>
     * ```
     *
     * @param {string} url the URL of the audio file
     * @param {string} title title of the audio track
     * @param {object} properties an object specifying init options for SlimSurfer
